...
export function LockedBlock({ title, description }) {
  ...
  return (
    <div data-testid="premium-locked-block" className="surface rounded-2xl p-6 border border-[#D4AF37]/25">
      <div className="flex items-center gap-3">
        <div className="w-9 h-9 rounded-xl bg-[#D4AF37]/15 flex items-center justify-center shrink-0"><Lock className="w-4 h-4 text-[#D4AF37]" /></div>
        ...
        <button onClick={() => navigate("/planos")} data-testid="unlock-btn"
          className="rounded-full bg-[#D4AF37] text-[#0B0C10] hover:bg-[#c9a431] px-4 py-2 text-sm font-medium shrink-0 transition-colors inline-flex items-center gap-1">
...
export function UpgradeWall({ feature }) {
  ...
  return (
    <div className="px-6 md:px-16 py-20 max-w-[720px] mx-auto text-center" data-testid="upgrade-wall">
      ...
      <span className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-[#D4AF37] mb-4"><Lock className="w-4 h-4" /> Funcionalidade Premium</span>
      ...
      <button onClick={() => navigate("/planos")} data-testid="upgrade-cta"
        className="rounded-full bg-[#D4AF37] text-[#0B0C10] hover:bg-[#c9a431] px-8 py-4 font-medium inline-flex items-center gap-2 transition-colors">
