    ...
    <div className="min-h-screen grid lg:grid-cols-2 text-foreground relative z-10 overflow-hidden"
      ...
      <div className="hidden lg:flex flex-col justify-center items-center p-16 relative overflow-hidden">
        ...
        <div className="relative flex items-center justify-center" style={{ width: 300, height: 300 }}>
          <div className="absolute -inset-3 rounded-[2.2rem]" style={{ background: "radial-gradient(circle, rgba(59,130,246,0.4), transparent 70%)", filter: "blur(34px)" }} />
          <img src="/android_ceo.png" alt="CEO AI" className="relative w-full h-full object-cover rounded-[2rem] ring-1 ring-blue-400/25 shadow-[0_0_55px_rgba(59,130,246,0.45)]" />
        </div>
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm">
          <div className="lg:hidden flex justify-center mb-8">
            <div className="relative flex items-center justify-center" style={{ width: 132, height: 132 }}>
              <div className="absolute -inset-2 rounded-[1.6rem]" style={{ background: "radial-gradient(circle, rgba(59,130,246,0.4), transparent 70%)", filter: "blur(18px)" }} />
              <img src="/android_ceo.png" alt="CEO AI" className="relative w-full h-full object-cover rounded-[1.4rem] ring-1 ring-blue-400/25 shadow-[0_0_28px_rgba(59,130,246,0.45)]" />
            </div>
          </div>
