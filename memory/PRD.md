...
- 📌 FASE 2 (pendente): gráfico de 2 linhas, 3 cenários (Conservador/Realista/Ambicioso), sliders interativos, plano anual (tabela). FASE 3: "Como foi calculado?" + relatório PDF.
